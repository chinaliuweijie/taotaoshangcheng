...
@Test
	public void testJedisPool(){
		...
		JedisPool jedisPool = new JedisPool("192.168.121.131", 6379);
		//从连接池中获得连接
	...
	public void testJedisCluster(){
		...
		//向集合中添加节点
		nodes.add(new HostAndPort("192.168.121.131", 7001));
		nodes.add(new HostAndPort("192.168.121.131", 7002));
		nodes.add(new HostAndPort("192.168.121.131", 7003));
		nodes.add(new HostAndPort("192.168.121.131", 7004));
		nodes.add(new HostAndPort("192.168.121.131", 7005));
		nodes.add(new HostAndPort("192.168.121.131", 7006));
		//创建JedisCluster对象
