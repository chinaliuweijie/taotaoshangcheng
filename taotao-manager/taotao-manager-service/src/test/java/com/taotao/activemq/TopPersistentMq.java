...
public class TopPersistentMq {
	...
	public void testTopicPersistenceProducer() throws JMSException{
		...
		ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://192.168.121.128:61616");
...
//		textMessage.setText("hello,activemq!!!");
		//第二种方式：
		TextMessage textMessage = session.createTextMessage("hello,activemq topic24444");
		//11.发送消息
